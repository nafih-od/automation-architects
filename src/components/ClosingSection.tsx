  ...
  return (
    <section className="py-28 md:py-36 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.04]" style={{
        background: "radial-gradient(600px circle at 50% 50%, hsl(170 75% 42%), transparent 70%)"
      }} />
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-10 py-4 rounded-md font-medium text-sm hover:opacity-90 transition-opacity glow"
          >
